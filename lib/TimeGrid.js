...
var TimeGrid =
  ...
  (function(_Component) {
    ...
    function TimeGrid(props) {
      ...
      _this.baseMin = (0, _moment.default)()
        .set({
          hour: 0,
          minute: 0,
          second: 0,
        ...
        .toDate()
      _this.baseMax = (0, _moment.default)()
        .set({
          hour: 23,
          minute: 59,
          second: 59,
          ...
          return _react.default.createElement(
            ...
            _react.default.createElement(
              ...
              (0, _extends2.default)({}, _this2.props, {
                localizer: localizer,
                min: showMin
                  ? dates.merge(date, _this2.baseMin)
                  : dates.merge(date, min),
                max: showMax
                  ? dates.merge(date, _this2.baseMax)
            ...
            workingHourEnabled &&
              !showMax &&
              (0, _moment.default)(max).hours() !== 23 &&
              _react.default.createElement(
                'div',
                {
                  className: (0, _clsx.default)(
...
TimeGrid.propTypes =
  process.env.NODE_ENV !== 'production'
    ? {
        ...
        workingHourComponent: _propTypes.default.node.isRequired,
        workingHourEnabled: _propTypes.default.bool.isRequired,
        disableTimeGutter: _propTypes.default.bool.isRequired,
        autoShowWorkingHours: _propTypes.default.bool.isRequired,
        slotSelectionColor: _propTypes.default.string,
