    ...
    function WeekWrapper() {
      ...
      _this._selectable = function() {
        ...
        selector.on('beforeSelect', function(point) {
          ...
          var bounds = (0, _Selection.getBoundsForNode)(node) // eventOffsetLeft is distance from the left of the event to the initial
          ...
          _this.eventOffsetLeft = point.x - bounds.left
