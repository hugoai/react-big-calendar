!(function(e, t) {
          ...
          if (M) {
            if (i) {
              var k = 'y' === w ? qt : Jt,
                ...
                H = L[x],
                I = On(0, S[T], F[T]),
                z = b ? S[T] / 2 - N - I - W - O : R - I - W - O,
                U = b ? -S[T] / 2 + N + I + H + O : Y + I + H + O,
  ...
  var Nr = (function() {
    ...
    return (
      ...
      (t.isSelected = function(e) {
        ...
        return !(!t || !this.selecting) && Rr(t, Yr(e))
      }),
      (t.filter = function(e) {
  ...
  function Da(e, t, n, r) {
    var o = J(r.start(e), 'day'),
      i = r.end(e),
      a = oe(o, n, 'day'),
      s = ee(o, i, 'minutes') ? ne(i, t, 'minutes') : te(i, t, 'minutes')
    return a && s
  }
  function Oa(e, t) {
  ...
  ;(Na.propTypes = {}), (Na.defaultProps = a({}, Lr))
  var Ra = function(e) {
    var t = e.children
    return r.createElement(
      'div',
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                a({ isAllDay: D }, N),
                T.map(function(e, t) {
                  return r.createElement(Ir, a({ key: t, segments: e }, N))
                }),
                !!P.length &&
                  r.createElement(
                    Na,
                    a({ segments: P, onShowMore: this.handleShowMore }, N)
                  )
              )
            )
          )
    ...
    return (
      ...
      (o.renderEvents = function(e, t, n, o) {
        var i = this,
          ...
          m = p.showMin,
          v = p.showMax,
          y = this.memoizedResources(this.props.resources, f),
          g = y.groupEvents(t),
          b = !1,
          w = !1
        return y.map(function(t, n) {
          ...
          return e.map(function(e, t) {
            var y = (g.get(s) || [])
                .map(function(e) {
                  return Va(f.start(e)).hour() < Va(c).hour() && !m
                    ? ((b = !0), !1)
            ...
            return (
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  a({}, i.props, {
                    localizer: d,
                    min: Me(e, m ? i.baseMin : c),
                    max: Me(e, v ? i.baseMax : l),
                    resource: p && s,
                    components: u,
                    isNow: ee(e, o, 'day'),
                    key: n + '-' + t,
        ...
        return (
          t.forEach(function(e) {
            if (Da(e, M, S, f)) {
              var t = f.start(e),
                n = f.end(e)
              f.allDay(e) || (Se(t) && Se(n)) || (!v && !ee(t, n, 'day'))
                ? D.push(e)
                : O.push(e)
            }
          }),
          ...
          r.createElement(
            'div',
            { className: k('rbc-time-view', l && 'rbc-time-view-resources') },
            r.createElement(ks, {
              range: o,
              events: D,
              width: i,
            ...
            r.createElement(
              ...
              r.createElement(Ss, {
                ...
                ref: this.gutterRef,
                localizer: h,
                min: Me(M, w ? this.baseMin : p),
                max: Me(M, _ ? this.baseMax : m),
  ...
  ;(Rs.propTypes = {}),
    (Rs.defaultProps = Ts.defaultProps),
    (Rs.range = Cs),
    (Rs.navigate = js.navigate),
